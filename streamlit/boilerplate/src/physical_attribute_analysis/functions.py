...
def convert_data(game_id):
    ...
    final.to_csv(f"final_data/final_home_{game_id}.csv")
...
def read_preprocessed_data(path):
    ...
    tracking_home = calc_player_velocities(tracking_home, smoothing=False)
